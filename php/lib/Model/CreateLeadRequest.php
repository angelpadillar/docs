 ...
 */
class CreateLeadRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateLeadRequest';
    ...
    */
     ...
     * Sets first_name
     *
     * @param string $first_name First name of the lead
     *
     * @return self
     */
     ...
     * Sets last_name
     *
     * @param string $last_name Last name of the lead
     *
     * @return self
     */
